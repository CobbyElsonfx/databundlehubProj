    ...
    <div class="row  container-fluid">
        ...
        <div class="col-sm-12 col-md-4 d-flex justify-content-center align-items-center">
            ...
            <ul class="hours-list">
                ...
                <li><span><a href="privacy.php">Privacy Policy</a> </span></li>
            </ul>
        </div>
    ...
    <div class="container-fluid">    
            ...
            <div class="col-lg-6">
                <div class="widget">
                    <div class="footer-text text-left">
                        ...
                        <p>At dataBundleshub, we are more than just a data bundle provider; we are your gateway to
                            seamless connectivity and affordable data solutions. </p>
                        <div class="social">
                            <a href="<?= $data['facebook'] ?>" data-toggle="tooltip" data-placement="bottom"
                                title="Facebook"><i class="fa fa-facebook"></i></a>
                            <a href="<?= $data['twitter'] ?>" data-toggle="tooltip" data-placement="bottom"
                                title="Twitter"><i class="fa fa-twitter"></i></a>
                            <a href="<?= $data['instagram'] ?>" data-toggle="tooltip" data-placement="bottom"
                                title="Instagram"><i class="fa fa-instagram"></i></a>
                            <a href="<?= $data['github'] ?>" data-toggle="tooltip" data-placement="bottom"
                                title="Github"><i class="fa fa-github"></i></a>
                            <a href="<?= $data['linkedin'] ?>" data-toggle="tooltip" data-placement="bottom"
                    ...
                    <div class="link-widget">
                        <ul>
                            ...
                            while ($cat = mysqli_fetch_assoc($popu)) {
                                ?>
                                <li><a href="index.php?id=<?= $cat['id'] ?>&catwisepost"><?= $cat['category_name'] ?>
                                        <span><?php echo Category::countCategoryPost($cat['id']); ?></span></a></li>
                            <?php } ?>
                        </ul>
                    </div><!-- end link-widget -->
                </div><!-- end widget -->
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <br>
                <div class="copyright"> <?= $siteData['footer'] ?> <a
                        href="<?= $data['footerlink'] ?>"><?= $data['footertxt'] ?></a>.</div>
            </div>
        </div>
    </div>
</footer>
...
alert(
                ...
                "If you encounter any issues after placing an order, please report them to +233 539821538 using the format below. Be aware that there may be delays of several hours for orders to be processed"
            );
        };
    </script>
