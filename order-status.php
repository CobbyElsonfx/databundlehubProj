...
<body>
        ...
        <section class="section">
            <h4 class="text-center p-3 my-3">Please take note, it may up take up  to an an hour  for your order to reflect after filling the form. Please check back later </h4>


            <div class="  px-2 mx-2 mt-5  ">
            ...
            <?php require_once 'footerdatatables.php' ?>